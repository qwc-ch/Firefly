...
export const zh_CN: Translation = {
	...
	[Key.archiveDescription]:
		"按时间线归档站内全部文章，快速回顾过往的分享与记录。",
	[Key.search]: "搜索",
	[Key.searchDescription]: "搜索站内全部内容，包括文章、标签与关键词。",
	...
	[Key.categoriesDescription]: "按分类浏览全部文章，更快找到感兴趣的主题。",
	[Key.allTags]: "全部标签",
	[Key.tagsDescription]: "按标签浏览全部文章，快速定位感兴趣的主题。",
